    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full overflow-y-auto bg-white px-3 pb-4">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('index.donation') }}" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100">
                        ...
                        <span class="text-s ms-3 flex-1 whitespace-nowrap text-sm">Donasi Sekarang</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('donationMoney.edit') }}" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100">
                          <svg class="h-4 w-4 text-zinc-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('list.pencairan') }}" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100">
                          <svg class="h-4 w-4 text-zinc-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
