                ...
                <div class="absolute inset-0 flex flex-col items-center justify-end bg-white bg-opacity-0 min-h-[800px]  z-20 text-center">
                    ...
                    <div class="p-5 bg-white rounded-3xl w-full text-left min-h-[620px]">
                        ...
                        <div class="w-full min-h-[250px]">
                            @php $isBarangDisplayed = false; @endphp
                                ...
                                @if ($target->nama_barang === 'Uang')
                                    ...
                                    <div class="flex justify-between w-full">
                                        ...
                                        <div class="w-1/2 flex justify-start items-center">
                                            ...
                                            <span class="px-2 font-bold text-sm">Rp {{ number_format($target->jumlah_barang,0,',','.') }},-</span>
                                        </div>
                                    </div>
                                @else
                                <div class="w-full mt-5">
                                    @if (!$isBarangDisplayed)
                                        <p class="pb-1">Barang</p>
                                        @php $isBarangDisplayed = true; @endphp
                                    @endif
                                    <div class="flex justify-between w-full py-1">
                                        <div class="w-1/2 flex justify-start items-center">
                                            ...
                                            <span class="px-2 text-sm"><strong>0</strong> {{ $target->nama_barang }}</span>
                                        </div>
                                        ...
                                        <div class="w-1/2 flex justify-start items-center">
                                            ...
                                            <span class="px-2 text-sm"><strong>{{ $target->jumlah_barang }}</strong> {{ $target->nama_barang }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
