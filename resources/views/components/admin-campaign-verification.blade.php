<div class="mb-8 pe-8" school-verification-id="{{ $verificationId }}">
    <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
        ...
        <div class="inline-flex w-full rounded-md shadow-sm" role="group">
            <button type="button" data-modal-target="confirm-modal{{$verificationId}}" data-modal-toggle="confirm-modal{{$verificationId}}"
            ...
            <button type="button" data-modal-target="decline-modal{{$verificationId}}" data-modal-toggle="decline-modal{{$verificationId}}"
...
<!-- Confirm modal -->
<div id="confirm-modal{{$verificationId}}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600 md:p-5">
                ...
                <button type="button"
                    ...
                    data-modal-hide="confirm-modal{{$verificationId}}">
            ...
            <div class="flex items-center rounded-b border-t border-gray-200 p-4 dark:border-gray-600 md:p-5">
                <button type="submit" name="response" value="confirm"
                    ...
                    saya yakin</button>
                <button data-modal-hide="confirm-modal{{$verificationId}}" type="button"
...
<!-- Decline modal -->
<div id="decline-modal{{$verificationId}}" tabindex="-1" aria-hidden="true"
    class="top-50 fixed left-0 right-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0">
    <div class="relative max-h-full w-full max-w-2xl p-4">
        <!-- Modal content -->
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600 md:p-5">
                ...
                <button type="button"
                    class="ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-hide="decline-modal{{$verificationId}}">
                    <svg class="h-3 w-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
            ...
            <div class="flex items-center rounded-b border-t border-gray-200 p-4 dark:border-gray-600 md:p-5">
                ...
                <button data-modal-hide="decline-modal{{$verificationId}}" type="button"
                    class="ms-3 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Batal</button>
            </div>
        </div>
    </div>
