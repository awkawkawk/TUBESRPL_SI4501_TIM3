...
@section('content')
    <div class="flex h-full w-full flex-row flex-wrap items-center justify-center">
        ...
        @endif
        <div class="mb-46 h-full bg-gradient-to-r from-gray-900 to-gray-700 w-full">
            <div id="default-carousel" class="relative ml-8 mb-8 mt-12 h-4/5 w-full px-32 drop-shadow-xl" data-carousel="slide">
                <!-- Carousel wrapper -->
...
<div class="flex w-full items-center mt-4 justify-center text-center">
