...
@section('content')
    <div class="flex h-full w-full flex-row flex-wrap items-center justify-center">
        ...
        <div id="toast-success"
            class="mt-4 flex w-full items-center bg-white bg-gradient-to-r from-gray-700 to-gray-500 p-4 text-white shadow dark:bg-gray-800 dark:text-gray-400"
            role="alert">
            <div
        ...
        @endif
        <div class="mb-46 h-full w-full bg-gradient-to-r from-gray-900 to-gray-700">
            <div id="default-carousel" class="relative mb-8 ml-8 mt-12 h-4/5 w-full px-32 drop-shadow-xl"
                data-carousel="slide">
                <!-- Carousel wrapper -->
    ...
    <div class="flex h-80 w-screen items-center justify-center bg-gradient-to-r from-gray-900 to-gray-700 lg:h-44">
        <div class="m-8 w-1/5 p-2 text-center text-2xl font-bold tracking-widest text-white">
            Yuk, Donasikan Lagi untuk Sekolah!
        </div>
        <div id="controls-carousel" class="relative h-full w-4/5 lg:h-36" data-carousel="slide">
            <div
                class="relative me-16 ms-16 h-full overflow-hidden rounded-lg border border-gray-500 bg-white shadow-[-100px_0px_200px_-50px_#cbd5e0] drop-shadow-md">
    ...
    <div class="mt-4 flex w-full items-center justify-center text-center">
        <div
            class="from-primary to-primarylight mt-6 grid w-4/5 grid-cols-4 gap-10 rounded-lg bg-gradient-to-r p-4">
    ...
    <div class="col-span-3 mb-8 w-full lg:mt-4">
        <p class="h1 mb-2 block text-center text-xl font-semibold text-black">Campaign Populer</p>
        <p class="mx-auto mb-8 w-1/2 text-center text-sm font-light text-black">Mereka butuh uluran tangan kita.
            Karena
            sedikit
            bantuan
        ...
        <div class="w-full text-center">
            <button type="button" onclick="renderCampaignCards(@json($campaigns))"
                class="bg-primary mb-8 mt-4 inline-flex h-10 items-center rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Lihat
