    ...
    <div class="md:col-span-1">
        <div class="container" style="display: flex; justify-content: center;">
            <div class="w-full sm:max-w-lg mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg" >
                <p class="h1 mt-2 mb-2 block text-xl font-semibold text-black" >Ringkasan Edit Donasi</p>
                <hr>

                <!-- Instruksi Pembayaran -->
                <p class="mb-2 mt-6 text-sm font-normal text-black dark:text-gray-400">Pastikan Data Yang Anda Ubah Denar</p>
                ...
                <p class="mb-2 mt-4 text-sm font-normal text-black dark:text-gray-400">Jumlah yang di donasikan</p>
                <div class="border border-gray-300 focus-within:border-indigo-500 rounded-md shadow-sm block mt-1 w-full px-3 py-2">
                    @if($nominal)
                ...
                <!-- Ringkasan Donasi -->
                <p class="h1 mb-2 mt-8 block text-sm font-semibold text-black" >Ringkasan Perubahan Data Donasi</p>
                <div class="border border-gray-300 focus-within:border-indigo-500 rounded-md shadow-sm block w-full px-3 py-2 bg-blue-100">
                    ...
                    @if($waktu_donasi)
                    <div class="flex justify-between items-center">
                        <p class="mb-2 text-sm font-normal text-black dark:text-gray-400">Waktu Perubahan Donasi</p>
                ...
                <form method="POST" action="{{ route('donations.update',  ['id' => session('formdonation')]) }}">
                    ...
                    <p class="mb-2 mt-4 text-xs font-normal text-black dark:text-gray-400">Pastikan data yang anda ubah sudah sesuai</p>
