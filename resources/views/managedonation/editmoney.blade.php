...
<div class="grid h-fit w-full grid-flow-row">
    <div class="col-span-2 md:col-span-1">
        <div class="mt-4 text-left">
            <div class="flex items-center mb-8">
                ...
                <a href="{{ url()->previous()}}" referrerpolicy="no-referrer" class="text-sm font-light text-gray-700 text-justify" style="margin-left: 8px;"><b>Kembali</b></a>
            </div>
        </div>
    </div>
    <div class="mb-2"></div>
    ...
    <div class="col-span-2 h-auto">
        <div class="flex space-x-4">
            <a href="{{ route('donationMoney.edit') }}" class="h1 mt-2 ml-2 mb-4 block text-l font-semibold text-black">Donasi Uang</a>
            <a href="{{ route('donationItem.edit') }}" class="h1 mt-2 ml-2 mb-4 block text-l font-normal text-black">Donasi Barang</a>
