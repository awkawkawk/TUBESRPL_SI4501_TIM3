    ...
    <div class="col-span-2 h-auto">
        ...
        <div class="h-auto w-full rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
            <div class="mb-4 grid grid-cols-8 gap-x-4 lg:gap-x-8" style="grid-template-columns: 0.1fr 0.5fr 1fr 1fr 1fr 1fr 1fr 1fr">
                ...
                <div>
                    <p class="h1 mb-2 block text-sm font-semibold text-black mt-6">Pembayaran</p>
                    <p class="mr-6 text-sm font-normal text-black dark:text-gray-400">Sun Jae</p>
                    <p class="mr-6 text-sm font-normal text-black dark:text-gray-400">Bank Mandiri</p>
                    <p class="mr-6 text-sm font-normal text-black dark:text-gray-400">111122233344</p>
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="mb-4 mr-6 text-sm font-normal text-black dark:text-gray-400">Semoga Membantu</p>
                    </p>
                </div>
                <div>
                    <p class="h1 mb-2 block text-sm font-semibold text-black mt-6">Status</p>
                    <p class="mb-4 mr-6 text-sm font-normal text-black dark:text-gray-400">Valid</p>
